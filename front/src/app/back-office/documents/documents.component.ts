...
export class DocumentsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.generalService.getCount(this.chosenEntity).subscribe(res => {
      this.documentsLength = res;
    }, err => {
    })
  
    this.dataSource = new GeneralDataSource(this.generalService);
    this.dataSource.loadItems(0, 5, this.activeSortHeader, this.valueSortHeader, "", this.chosenEntity);
  ...
  loadDocumentPage() {
    ...
    this.dataSource.loadItems(this.paginator.pageIndex * this.paginator.pageSize, this.paginator.pageSize, this.activeSortHeader, this.valueSortHeader, this.input.nativeElement.value, this.chosenEntity)
  }
