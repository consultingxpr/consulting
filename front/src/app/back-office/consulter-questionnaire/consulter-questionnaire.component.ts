...
@Component({
  selector: 'app-consulter-questionnaire',
  templateUrl: './consulter-questionnaire.component.html',
  styleUrls: ['./consulter-questionnaire.component.scss']
})
export class ConsulterQuestionnaireComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.queryParams.subscribe(params=>{
      this.id=params["id"];
      this.formulaireService.getByUser(this.id).subscribe(res => {
        if (res.success) {
